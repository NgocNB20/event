...
<body>
	...
	<div class="body_form">
		...
		<form:form action="./addEvent" method="POST" enctype="multipart/form-data"  modelAttribute="eventAddModel">
			...
			<div id="form_left_max">
				...
				<div style="text-align: center;">
					<i class="fa-solid fa-circle-info">&emsp;<u>Event
							...
							<!-- <input type="text" placeholder="nhap name event" name="eventName" id="EventName" required><br> &emsp; -->
							<form:input path="eventName"/><br> &emsp;
...
<%-- 					<form:select path="" items="listOption">
					</form:select> --%>
